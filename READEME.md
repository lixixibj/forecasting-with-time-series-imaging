Time series image feature extraction with Sift and Pretrained CNN
================
Xixi Li
2020-05-11

This pape introduces how to use our python code for time series image feature extraction.
...
-----------------
In the folder `feature_extraction_with_sift`, the function `image_based_batch_ts_feature_extraction_with_sift(file_path_of_ts,file_path_of_feature,num_cores)` in the file `compute_features_sift.py` is used to compute features of time series image.

Parameters explaination for function `image_based_batch_ts_feature_extraction_with_sift(file_path_of_ts,file_path_of_feature,num_cores)`:
- `file_path_of_ts`: the file path of your time series data and it is saved in the format of csv.
- `file_path_of_feature`: the file path where you want to save the extracted feature
...
-----------------
In the folder `feature_extraction_with_pretrained_CNN`, the function `image_based_batch_ts_feature_extraction_with_sift(file_path_of_ts,file_path_of_feature,num_cores)` in the file `compute_features_cnn.py` is used to compute features of time series image.

Parameters explaination for function `image_based_batch_ts_feature_extraction_with_cnn(file_path_of_ts,file_path_of_feature,cnn_model_name,file_path_of_pretrained_model,num_cores)`:
- `file_path_of_ts`: the file path of your time series data and it is saved in the format of csv.
- `file_path_of_feature`: the file path where you want to save the extracted feature
...
We show an exmple:
    ...
    image_based_batch_ts_feature_extraction_with_cnn(file_path_of_ts,file_path_of_feature,cnn_model_name,file_path_of_pretrained_model,num_cores)
